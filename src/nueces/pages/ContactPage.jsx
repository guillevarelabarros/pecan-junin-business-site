    ...
    <div className="container mt-5">
      ...
      <div className="mt-4">
        ...
        <ul>
          ...
          <li><strong>Facebook:</strong> Contáctanos a través de nuestra página de <a href="https://www.facebook.com/pecanjunin" target="_blank" rel="noopener noreferrer">Facebook</a>.</li>
        </ul>
      </div>
    </div>
  );
